...
int main() {
  ...
  paraview("vtk_files/trial/trialu_" + to_string(1) + ".vtk", u_new, nx, ny, dx, dy, "u");
  paraview("vtk_files/trial/trialv_" + to_string(1) + ".vtk", v_new, nx, ny, dx, dy, "v");
  paraview("vtk_files/trial/trialp_" + to_string(1) + ".vtk", p, nx, ny, dx, dy, "p");
  ...
  for (int i=2; i<=5000; i++) {
    ...
    if (i % 100 == 0) {
      paraview("vtk_files/trial/trialu_" + to_string(i) + ".vtk", u_new, nx, ny, dx, dy, "u");
      paraview("vtk_files/trial/trialv_" + to_string(i) + ".vtk", v_new, nx, ny, dx, dy, "v");
      paraview("vtk_files/trial/trialp_" + to_string(i) + ".vtk", p, nx, ny, dx, dy, "p");
      cout << i << "\n";
    }
  }
}
