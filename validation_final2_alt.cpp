...
int main() {
  ...
  cout << "Start solving ...\n";
  double dt = 0.00001; // Previously 0.005
  double t = 0.0;
  ...
  // read_restartfile(F_n, name_prefix, "F_n", it, nx, ny);
  // read_restartfile(G_n, name_prefix, "G_n", it, nx, ny);
  // read_restartfile(u_new, name_prefix, "u_new", it, nx, ny);
  // read_restartfile(v_new, name_prefix, "v_new", it, nx, ny);
  // read_restartfile(p, name_prefix, "p", it, nx, ny);
  // read_restartfile(phi, name_prefix, "phi", it, nx, ny);
  // read_restartfile(phi_half, name_prefix, "phi_half", it, nx, ny);
  // read_restartfile(phi_new, name_prefix, "phi_new", it, nx, ny);
}
